...
#pragma region Raycasting functions
...
#pragma region CollsionCheck

//distribute the right Collsion situation
bool CollisionDetection::ObjectIntersection(GameObject* a, GameObject* b, CollisionInfo& collisionInfo) {
	if (a->OBJtype == 0 && b->OBJtype == 0) {}
	else if (a->OBJtype == 5 && b->OBJtype == 0){}
	else if (a->OBJtype == 0 && b->OBJtype == 5) {}
	else if (a->OBJtype == 4 && b->OBJtype == 3) {}
	else if (a->OBJtype == 3 && b->OBJtype == 4) {}

	else if (a->OBJtype == 4 && b->OBJtype == 0) {}
	else if (a->OBJtype == 0 && b->OBJtype == 4) {}

	else if (a->OBJtype == 5 && b->OBJtype == 2) {}
	else if (a->OBJtype == 2 && b->OBJtype == 5) {}
	else if (a->OBJtype == 2 && b->OBJtype == 4) {}
	else if (a->OBJtype == 4 && b->OBJtype == 2) {}

	else if (a->OBJtype == 6 && b->OBJtype != 1) {}
	else if (a->OBJtype != 1 && b->OBJtype == 6) {}

	else if (a->OBJtype == 5 && b->OBJtype == 7) {}
	else if (a->OBJtype == 7 && b->OBJtype == 5) {}
	else if (a->OBJtype == 7 && b->OBJtype == 4) {}
	else if (a->OBJtype == 4 && b->OBJtype == 7) {}
	else if (a->OBJtype == 7 && b->OBJtype == 0) {}
	else if (a->OBJtype == 0 && b->OBJtype == 7) {}
	else if (a->OBJtype == 7 && b->OBJtype == 2) {}
	else if (a->OBJtype == 2 && b->OBJtype == 7) {}
	else if (a->OBJtype == 7 && b->OBJtype == 7) {}
	else if (a->OBJtype == 10 || b->OBJtype == 10) {}
	else {
		...
		if (volA->type == VolumeType::AABB && volB->type == VolumeType::Sphere) {
			...
			return AABBSphereIntersection((AABBVolume&)*volA, transformA,
				(SphereVolume&)*volB, transformB, collisionInfo, a, b);
		}
		// sphere & square
		if (volA->type == VolumeType::Sphere && volB->type == VolumeType::AABB) {
				...
				return AABBSphereIntersection((AABBVolume&)*volB, transformB,
					(SphereVolume&)*volA, transformA, collisionInfo, a, b);
		}
	}
	return false;
}
...
bool CollisionDetection::AABBSphereIntersection(const AABBVolume& volumeA, const Transform& worldTransformA,
	const SphereVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo, GameObject* a, GameObject* b) {
	...
	if (distance < volumeB.GetRadius()) {// yes , we ’re colliding !
		if (a->OBJtype == 6 || b->OBJtype == 6) { 
			if (a->OBJtype == 1 )
			{
				a->OnCollisionSpeed(b);
				return false;
			}
			else if (b->OBJtype == 1)
			{
				b->OnCollisionSpeed(a);
				return false;
			}
		}
		collisionInfo.AddContactPoint(
